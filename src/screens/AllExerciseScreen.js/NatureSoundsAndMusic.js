...
const NatureSoundsAndMusic = () => {
    ...
    const fetchExercises = async () => {
      try {
        const snapshot = await firestore()
          ...
          .where('style', '==', 'Nature Sounds and Music')
          .get();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titleText}>Nature Sounds And Music</Text>
...
export default NatureSoundsAndMusic;
