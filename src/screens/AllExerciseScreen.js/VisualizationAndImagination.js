...
const VisualizationAndImagination = () => {
    ...
    const fetchExercises = async () => {
      try {
        const snapshot = await firestore()
          ...
          .where('style', '==', 'Visualization and Imagination')
          .get();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titleText}>Visualization And Imagination</Text>
...
export default VisualizationAndImagination;
