...
const AffirmationsAndMantras = () => {
    ...
    const fetchExercises = async () => {
      try {
        const snapshot = await firestore()
          ...
          .where('style', '==', 'Affirmations And Mantras')
          .get();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titleText}>Affirmation And Mantras</Text>
...
export default AffirmationsAndMantras;
